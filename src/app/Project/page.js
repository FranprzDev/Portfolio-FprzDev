...
function ProjectDetail() {
  ...
  // TENGO QUE AGARRAR EL UNIVERSITY Y CON ESO FILETEO EL ARRAY
      ...
      {ProjectDetail?.projectsEN.map((project) => (
        <div className="bg-cards-projects-details mx-3">
          ...
          <div className="w-full flex justify-center py-2">
            <Image
              src={project?.image ? project?.image : "/Projects/University/AyED.png"}
              width={300}
              height={300}
          ...
          <div className="w-full flex justify-end gap-3 pr-3 py-3">
            {
              project?.demo ? (
                <a className="text-third hover:text-first text-3xl md:text-5xl lg:text-7xl" 
